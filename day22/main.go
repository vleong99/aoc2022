...
func main() {
	...
	portals = map[[4]int][4]int{ //new grid number, new row, new col , new direction. -1 means variable same, -2 means variable inverted (i.e. 49-v)
		//grid 1
		{1, 0, -1, 3}:  {6, -1, 0, 0}, //top 1 to left 6
		{1, -1, 49, 0}: {2, -1, 0, 0}, //right 1 to left 2
		{1, 49, -1, 1}: {3, 0, -1, 1}, // bottom 1 to top 3
		{1, -1, 0, 2}:  {4, -2, 0, 0}, // left 1 to left 4
		//grid 2
		{2, 0, -1, 3}:  {6, 49, -1, 3}, //top 2 to bottom 6
		{2, -1, 49, 0}: {5, -2, 49, 2}, // right 2 to right 5
		{2, 49, -1, 1}: {3, -1, 49, 2}, //bottom 2 to right 3
		{2, -1, 0, 2}:  {1, -1, 49, 2}, //left 2 to right 1
		//grid 3
		{3, 0, -1, 3}:  {1, 49, -1, 3}, //top 3 to bottom 1
		{3, -1, 49, 0}: {2, 49, -1, 3}, //right 3 to bottom 2
		{3, 49, -1, 1}: {5, 0, -1, 1},  //bottom 3 to top 5
		{3, -1, 0, 2}:  {4, 0, -1, 1},  //left 3 to top 4
		//grid 4
		{4, 0, -1, 3}:  {3, -1, 0, 0}, //top 4 to left 3
		{4, -1, 49, 0}: {5, -1, 0, 0}, // right 4 to left 5
		{4, 49, -1, 1}: {6, 0, -1, 1}, //bottom 4 to top 6
		{4, -1, 0, 2}:  {1, -2, 0, 0}, //left 4 to left 1

		//grid 5
		{5, 0, -1, 3}:  {3, 49, -1, 3}, //top 5 to bottom 3
		{5, -1, 49, 0}: {2, -2, 49, 2}, // right 5 to right 2
		{5, 49, -1, 1}: {6, -1, 49, 2}, //bottom 5 to right 6
		{5, -1, 0, 2}:  {4, -1, 49, 2}, //left 5 to right 4
		//grid 6
		{6, 0, -1, 3}:  {4, 49, -1, 3}, //top 6 to bottom 4
		{6, -1, 49, 0}: {5, 49, -1, 3}, // right 6 to bottom 5
		{6, 49, -1, 1}: {2, 0, -1, 1},  //bottom 6 to top 2
		{6, -1, 0, 2}:  {1, 0, -1, 1},  //left 6 to top 1
	}
